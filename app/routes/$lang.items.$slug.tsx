    ...
    <div className="flex flex-col gap-4 mb-8">
      ...
      {Array.isArray(data.outFactoryMachineCraftTable) && data.outFactoryMachineCraftTable.length > 0 && (
        <section id="recipes" className="scroll-mt-16">
          <h2 className="text-xl font-semibold mb-2">Obtaining</h2>
          <Separator className="mb-4" />
          <RecipeTable recipes={data.outFactoryMachineCraftTable} facilities={facilities} items={items} lang={lang} />
        </section>
      )}
      ...
      {Array.isArray(data.inFactoryMachineCraftTable) && data.inFactoryMachineCraftTable.length > 0 && (
        <section id="recipes" className="scroll-mt-16">
          ...
          <Separator className="mb-4" />
          <RecipeTable recipes={data.inFactoryMachineCraftTable} facilities={facilities} items={items} lang={lang} />
        </section>
      )}
    </div>
  );
